    ...
    public function downloadEoIApplication($action = null, $status = null)
    {
        ...
        if (!empty($application_list)) {
            ...
            fputcsv($handle, [
                ...
                "Technological Resources Category",
                "Technological Resources Type of resource",
                "Technological Resources Details of Resource",
                "Technological Resources Specification",
                "Technological Resources Purpose of Resource",
                "Technological Resources Alignment",
                "Human Resources Category",
                "Human Resources Type of resource",
                "Human Resources Name and contact details",
                "Human Resources Role",
                "Human Resources Experience",
                "Human Resources Extent of involvement in PoC",
            ...
            foreach ($application_list as $list) {
                ...
                if (strpos($list->upload_document, "Error") !== false) {
                ...
                fputcsv($handle, [
                    $i++,
                    isset($list->application_id) ? $list->application_id : '',
                    isset($list->user_id) ? $list->user_id : '',
                    isset($list->full_name) ? $list->full_name : '',
                    isset($list->email) ? $list->email : '',
                    isset($list->phone_number) ? $list->phone_number : '',
                    isset($list->register_as) ? $list->register_as : '',
                    isset($list->date_of_birth) ? $list->date_of_birth : '',
                    isset($list->core_competency) ? $list->core_competency : '',
                    isset($list->other_core_competencie) ? $list->other_core_competencie : '',
                    isset($list->experience) ? $list->experience : '',
                    isset($list->organization_name) ? $list->organization_name : '',
                    isset($list->alternate_email) ? $list->alternate_email : '',
                    isset($list->potential_interest_areas) ? $list->potential_interest_areas : '',
                    isset($list->office_address) ? $list->office_address : '',
                    isset($list->organisation_hq_address) ? $list->organisation_hq_address : '',
                    isset($list->website_url) ? $list->website_url : '',
                    isset($list->previous_experience) ? $list->previous_experience : '',
                    isset($list->achievements_recognitions) ? $list->achievements_recognitions : '',
                    isset($list->title) ? $list->title : '',
                    isset($list->category) ? $list->category : '',
                    isset($list->strategic_vision) ? $list->strategic_vision : '',
                    isset($list->objectives) ? $list->objectives : '',
                    isset($list->project_goals) ? $list->project_goals : '',
                    isset($list->contribution_to_project_goals) ? $list->contribution_to_project_goals : '',
                    isset($list->technological_category) ? $list->technological_category : '',
                    isset($list->technological_type_of_resource) ? $list->technological_type_of_resource : '',
                    isset($list->technological_details) ? $list->technological_details : '',
                    isset($list->specification) ? $list->specification : '',
                    isset($list->purpose) ? $list->purpose : '',
                    isset($list->alignment) ? $list->alignment : '',
                    isset($list->human_category) ? $list->human_category : '',
                    isset($list->human_type_of_resource) ? $list->human_type_of_resource : '',
                    isset($list->human_details) ? $list->human_details : '',
                    isset($list->human_experience) ? $list->human_experience : '',
                    isset($list->role) ? $list->role : '',
                    isset($list->role) ? $list->extent_of_involvement : '',
                    isset($list->human_alignment) ? $list->human_alignment : '',
                    isset($list->other_pertinent_facts) ? $list->other_pertinent_facts : '',
                    isset($upload_document) ? $upload_document : '',
                    isset($list->created_at) ? $list->created_at : '',
                    isset($status_text) ? $status_text : '',
                ]);
            }
            fclose($handle);
            exit();
    ...
    public function downloadSubmitedUseCases($action = null, $status = null)
    {
        ...
        if (!empty($application_list)) {
            ...
            fputcsv($handle, [
                ...
                "Objective",
                "Target Area",
                "Relevance to Sangam Initiative",
            ...
            foreach ($application_list as $list) {
                ...
                fputcsv($handle, [
                    $i++,
                    isset($list->case_id) ? $list->case_id : '',
                    isset($list->user_id) ? $list->user_id : '',
                    isset($list->full_name) ? $list->full_name : '',
                    isset($list->email) ? $list->email : '',
                    isset($list->phone_number) ? $list->phone_number : '',
                    ...
                    isset($list->website_url) ? $list->website_url : '',
                    isset($list->title) ? $list->title : '',
                    isset($list->abstract) ? $list->abstract : '',
                    isset($list->objective) ? $list->objective : '',
                    isset($list->target_areas) ? $list->target_areas : '',
                    isset($list->relevance) ? $list->relevance : '',
                    isset($list->technologies_used) ? $list->technologies_used : '',
                    isset($list->data_sources) ? $list->data_sources : '',
                    isset($list->expected_outcomes) ? $list->expected_outcomes : '',
                    isset($list->innovative_aspects) ? $list->innovative_aspects : '',
                    isset($list->feasibility_and_challenges) ? $list->feasibility_and_challenges : '',
                    isset($upload_document) ? $upload_document : '',
                    isset($list->created_at) ? $list->created_at : '',
                ]);
            }
