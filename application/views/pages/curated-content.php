             ...
             if (user_level === '1') {
               if (row.status === '1') {
                  ...
                  buttons +=
                      ...
                      '<button type="button" class="btn btn-primary btn-sm" onclick="viewCuratedContent(\'' + row.cc_id + '\')">' +
                      ' View' +
                      '</button>' +
                      '<button type="button" class="btn btn-info btn-sm" onclick="approveCuratedContent(\'' + row.cc_id + '\')">' +
                      ' Approve' +
                      '</button>' +
                      '<button type="button" class="btn btn-danger btn-sm" onclick="rejectCuratedContent(\'' + row.cc_id + '\')">' +
                      ' Reject' +
                      '</button>' +
                      '</div>';
               } else {
                 ...
                 buttons +=
                     ...
                     '<li><a href="javascript:void(0)" class="dropdown-item" onclick="viewCuratedContent(\'' + row.cc_id + '\')"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>' +
                     '</ul>' +
                     '</div>';
             }
