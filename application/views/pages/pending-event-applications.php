            ...
            <div class="card">
               <div class="card-header align-items-center d-flex">
                  ...
                  <div class="flex-shrink-0">
                     <button type="button" id="downloadPendingApplication" class="btn btn-primary btn-sm material-shadow-none"><i class="ri-download-fill"></i> Download Excel</button>
                  </div>
               </div>
               <div class="card-body">
...
<script>
   ...
   function initializeDataTable() {
      ...
      var dataTable = $("#ajax-datatables").DataTable({
         ajax: {
            url: "<?php echo base_url('get-pending-event-registration'); ?>",
            type: "GET",
            dataType: "json",
            dataSrc: "data",
         },
   ...
   $(document).ready(function () {
      var dataTable = initializeDataTable();
      $("#downloadPendingApplication").click(function ()
      {
        var redirectUrl = "<?php echo base_url('download-event-registration/pending/1'); ?>";
        window.location.href = redirectUrl;
      })
   });
</script>
