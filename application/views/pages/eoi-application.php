                  ...
                  <div class="row row-cols-md-3 row-cols-1">
                     <div class="col col-lg border-end">
                        <div class="py-4 px-3">
                           ...
                           <a href="<?php echo base_url('download-eoi-application-list/all')?>" class="text-decoration-underline">Download Excel</a>
                        </div>
                     </div>
                     <div class="col col-lg border-end">
                        <div class="mt-3 mt-md-0 py-4 px-3">
                           ...
                           <a href="<?php echo base_url('download-eoi-application-list/all/2')?>" class="text-decoration-underline">Download Excel</a>
                        </div>
                     </div>
                     <div class="col col-lg border-end">
                        <div class="mt-3 mt-md-0 py-4 px-3">
                           ...
                           <a href="<?php echo base_url('download-eoi-application-list/pending/1')?>" class="text-decoration-underline">Download Excel</a>
                        </div>
                     </div>
                     <div class="col col-lg border-end">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                           ...
                           <a href="<?php echo base_url('download-eoi-application-list/rejected/3')?>" class="text-decoration-underline">Download Excel</a>
                        </div>
                     </div>
                     <div class="col col-lg">
                        <div class="mt-3 mt-lg-0 py-4 px-3">
                           ...
                           <a href="<?php echo base_url('download-eoi-application-list/incompleted/0')?>" class="text-decoration-underline">Download Excel</a>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="col-lg-12">
            <div class="card">
               <div class="card-header align-items-center d-flex">
                  <h4 class="card-title mb-0 flex-grow-1"><?php if (isset($flag)) {
                     echo ucwords($flag);}?> Application List</h4>
                  <div class="flex-shrink-0">
                    <?php
                      ...
                      echo '<a href="' . base_url('download-eoi-application-list/') . $flag . '/' . $value . '" class="btn btn-primary btn-sm material-shadow-none"><i class="ri-download-fill"></i> Download Excel</a>';
                      ?>
