                     ...
                     <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                        <div class="flex-grow-1">
                           <div id="greeting-container">
                              <h4 class="fs-16 mb-1"><span id="greeting-message"></span> <?php echo  $this->session->login['user_name']; ?></h4>
                           </div>
                                 ...
                                 <tbody>
                                       ...
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="avatar-sm bg-light rounded p-1 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/products/img-1.png" alt="" class="img-fluid d-block" />
                                             </div>
                                             <div>
                                    ...
                                    <tr>
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="avatar-sm bg-light rounded p-1 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/products/img-2.png" alt="" class="img-fluid d-block" />
                                             </div>
                                             <div>
                                    ...
                                    <tr>
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="avatar-sm bg-light rounded p-1 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/products/img-3.png" alt="" class="img-fluid d-block" />
                                             </div>
                                             <div>
                                    ...
                                    <tr>
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="avatar-sm bg-light rounded p-1 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/products/img-4.png" alt="" class="img-fluid d-block" />
                                             </div>
                                             <div>
                                    ...
                                    <tr>
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="avatar-sm bg-light rounded p-1 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/products/img-5.png" alt="" class="img-fluid d-block" />
                                             </div>
                                             <div>
                                 ...
                                 <tbody>
                                       ...
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="flex-shrink-0 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/companies/img-1.png" alt="" class="avatar-sm p-2" />
                                             </div>
                                             <div>
                                    ...
                                    <tr>
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="flex-shrink-0 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/companies/img-2.png" alt="" class="avatar-sm p-2" />
                                             </div>
                                             <div class="flex-grow-1">
                                    ...
                                    <tr>
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="flex-shrink-0 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/companies/img-3.png" alt="" class="avatar-sm p-2" />
                                             </div>
                                    ...
                                    <tr>
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="flex-shrink-0 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/companies/img-8.png" alt="" class="avatar-sm p-2" />
                                             </div>
                                             <div class="flex-grow-1">
                                    ...
                                    <tr>
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="flex-shrink-0 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/companies/img-5.png" alt="" class="avatar-sm p-2" />
                                             </div>
                                             <div class="flex-grow-1">
                                                <h5 class="fs-14 my-1 fw-medium">
                  ...
                  <div class="col-xl-8">
                     <div class="card">
                        <div class="card-header align-items-center d-flex">
                           ...
                           <div class="flex-shrink-0">
                              <button type="button" class="btn btn-soft-info btn-sm material-shadow-none"><i class="ri-file-list-3-line align-middle"></i> Generate Report</button>
                           </div>
                        </div>
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="flex-shrink-0 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-circle material-shadow" />
                                             </div>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="flex-shrink-0 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle material-shadow" />
                                             </div>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="flex-shrink-0 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle material-shadow" />
                                             </div>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="flex-shrink-0 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/users/avatar-4.jpg" alt="" class="avatar-xs rounded-circle material-shadow" />
                                             </div>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <div class="d-flex align-items-center">
                                             <div class="flex-shrink-0 me-2">
                                                <img src="<?php echo base_url(''); ?>include/admin/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle material-shadow" />
                                             </div>
