      ...
      <div class="col-lg-12">
         <div class="card">
            <div class="card-header align-items-center d-flex">
               <h4 class="card-title mb-0 flex-grow-1">Submited Speaker Request List</h4>
               <div class="flex-shrink-0">
                  <button type="button" id="downloadSpeakerListExcel" class="btn btn-primary btn-sm material-shadow-none"><i class="ri-download-fill"></i> Download Excel</button>
               </div>
            </div>
            <div class="card-body">
...
<script>
   function viewSpeaker(user_id) {
      ...
      $(document).ready(function() {
          ...
          $("#downloadSpeakerListExcel").click(function ()
          {
            var redirectUrl = "<?php echo base_url('download-submitted-speaker-request/all'); ?>";
            window.location.href = redirectUrl;
          })
      });
</script>
