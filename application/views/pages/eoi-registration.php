                                       ...
                                       <div class="row g-3">
                                         <div class="col-sm-12">
                                            <label for="other_pertinent_facts" id="additionalInformation" class="form-label">
                                               ...
                                               <div data-bs-toggle="tooltip" data-bs-placement="top" title="Only PDF file">
                                                  <a href="javascript:void(0)" class="text-muted"><i class="ri-info-i"></i></a>
                                               </div>
                                            </label>
                                          ...
                                          <div class="col-sm-12">
                                             ...
                                             <textarea name="other_pertinent_facts" class="form-control" id="other_pertinent_facts" placeholder="Please enter a other pertinent facts or offerings" width="100%" rows="5"><?php if (isset($userDetail->other_pertinent_facts)) {                                                                                                                                                                        }; ?></textarea>
