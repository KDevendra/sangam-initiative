                                    ...
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                            <form id="verify-account">
                                                <div class="row">
                                                    <?php
                                                    $hiddenEmail = encryptAndPartiallyDisplayEmail($email);
                                                    echo '<div class="alert alert-danger text-center"  role="alert"> <i class="ri-info-i" id="blinkText" style="background: red;border-radius: 50%;margin-right: 5px;padding: 0px;color: #fff;"></i>Verification code sent on <b>' . $hiddenEmail . '</b></div>';
                                                    ?>
                                                    <div class="form-group text-start col-md-6 mt-2">
                                                        ...
                                                        <a href="javascript:void(0)" id="resendCode" class="text-primary fw-bold mt-2"> <b>Resend Code</b> </a>
                                                    </div>
                                                    <div class="form-group text-start col-md-6 mt-2">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="position-relative auth-pass-inputgroup">
                                                                <div class="catpchaparent">
                                                                    ...
                                                                    <div class="capchchild">
                                                                        <canvas id="valicode" width="120" height="38"></canvas>
                                                                    </div>
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <button type="submit" id="submitBtn" class="btn btn-primary"><span class="loader"></span>Verify & Update</button>
                                                </div>
                                            </form>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function submitForm(formData) {
                $.ajax({
                    url: "<?php echo base_url('post-forgot-verify-account'); ?>",
                    type: "post",
                    data: formData,
