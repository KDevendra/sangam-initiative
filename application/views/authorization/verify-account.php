                                        ...
                                        <div class="p-lg-5 p-4">
                                            ...
                                            <div class="text-muted text-center mx-lg-3">
                                                ...
                                                <p>
                                                    ...
                                                    <span class="fw-semibold">
                                                        <?php  $hiddenEmail = encryptAndPartiallyDisplayEmail($user_id); echo $hiddenEmail; ?>
                                                    </span>
                                                </p>
                                            </div>
                                            ...
                                            <div class="mt-4">
                                                <form id="verify-account" autocomplete="off">
                                                    ...
                                                    <div class="mt-3">
                                                        <button type="button" class="btn btn-success w-100" id="verifyAccountBtn"><span class="loader"></span> Confirm</button>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        success: function (response) {
                            ...
                            if (response.status === "error") {
                                ...
                                $("#verify-account")[0].reset();
                                                Swal.fire({
                                    html:
                                        '<div class="mt-3"><lord-icon src="https://cdn.lordicon.com/lupuorrc.json" trigger="loop" colors="primary:#0ab39c,secondary:#405189" style="width:120px;height:120px"></lord-icon><div class="mt-4 pt-2 fs-15"><h4>Well done !</h4><p class="text-muted mx-4 mb-0">' +
                                        response.message +
                                        "</p></div></div>",
                                                        showCancelButton: !0,
          showConfirmButton: !1,
