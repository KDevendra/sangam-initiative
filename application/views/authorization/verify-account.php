                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === "error") {
                            ...
                            Swal.fire({
                                html: '<div class="mt-3"><lord-icon src="https://cdn.lordicon.com/lupuorrc.json" trigger="loop" colors="primary:#29c5f6,secondary:#405189" style="width:120px;height:120px"></lord-icon><div class="mt-4 pt-2 fs-15"><h4>Email Address has been verified!</h4><p class="text-muted mx-4 mb-0">' +
                                    response.message +
                                    "</p></div></div>",
                                showCancelButton: !0,
                                showConfirmButton: !1,
                                ...
                                cancelButtonText: "Click Here to Login",
                                buttonsStyling: !1,
                                showCloseButton: !0,
                            }).then(function() {
