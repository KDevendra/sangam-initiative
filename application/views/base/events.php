...
<section class="page-title-area text-white bg_cover mt___147" style="background-image: url('<?php echo base_url(); ?>include/web/custom/About_Banner.jpg');">
   <div class="container">
      <div class="page-title-inner text-center">
         ...
         <div class="gd-breadcrumb"><span class="breadcrumb-entry"><a href="<?php echo base_url(''); ?>">Home</a></span><span class="separator"></span><span class="breadcrumb-entry active">Event</span></div>
      </div>
   </div>
</section>
      ...
      <div class="event_accordion" id="event_accordionOne">
         <div class="row justify-content-center">
            <div class="col-lg-10">
               <div class="section-title text-center mb-30 wow fadeInDown">
                  <!-- <span class="sub-title"><img src="<?php echo base_url(''); ?>include/web/custom/technology.png" alt="" /> Weaving the Fabric of Events</span> -->
                  <h2>Schedule Outreach Program </h2>
               </div>
            </div>
         </div>
         <div class="custom-tabs">
            <button class="custom-tab-btn" data-tab="tab1">Sangam Delhi</button>
            <button class="custom-tab-btn" data-tab="tab2">Sangam Bangalore</button>
            <button class="custom-tab-btn active" data-tab="tab3">Sangam Hyderabad</button>
         </div>
         <div class="custom-tab-content" id="tab1" style="display: none;">
            <h5 class="mt-10 blink-text text-center mb-4" style="color: #ff0000b8;">5th March 2024 (09:00 to 17:30)</h5>
                        ...
                        <table class="table table-bordered">
                           ...
                           <tbody class="text-center">
                              ...
                              <tr class="bg-wzureish-white">
                                 <td>09:30-09:33</td>
                                 <td>3 mins</td>
                                 <td colspan="3"> Felicitation Ceremony</td>
                              </tr>
                              <tr class="bg-wzureish-white">
                                 <td>09:33-09:38</td>
                                 <td>5 mins</td>
                                 <td colspan="3">Lamp Lighting</td>
                              </tr>
                              <tr class="bg-wzureish-white">
                                 <td>09:38-09:43</td>
                                 <td>5 mins </td>
                              ...
                              <tr class="bg-wzureish-white">
                                 ...
                                 <td>Director, IIT Delhi</td>
                                 <td>Prof. Rangan Banerjee</td>
                              </tr>
                              <tr class="bg-wzureish-white">
                                 <td>09:50-10:05</td>
                                 <td>15 mins</td>
                        ...
                        <table class="table table-bordered">
                           ...
                           <tbody class="text-center">
                              <tr class="bg-wzureish-white">
                                 ...
                                 <td>Eros</td>
                                 <td>Ali Hussain, CEO, Eros Investment </td>
                              </tr>
                              <tr class="bg-wzureish-white">
                                 <td>11:15-11:35</td>
                                 <td> 20 mins</td>
                                 ...
                                 <td>Genesys</td>
                                 <td> Sh. Aniruddha Roy, CTO</td>
                              </tr>
                              <tr class="bg-wzureish-white">
                                 <td>11:35-11:50</td>
                                 <td>15 mins</td>
                                 <td rowspan="2" style="vertical-align: inherit;"><b>BIM Brilliance:</b> Refining Digital Detail for Superior Utility</td>
                                 <td> Bentley</td>
                                 <td>Amit Shrivastava, Sr. Director, S.E.</td>
                              </tr>
                              <tr class="bg-wzureish-white">
                                 <td>11:50-12:05</td>
                                 <td> 15 mins</td>
                                 <td>ESRI</td>
                                 <td> Sh. Vibhu Sinha, Sr. Manager</td>
                              </tr>
                        ...
                        <table class="table table-bordered">
                           ...
                           <tbody class="text-center">
                              ...
                              <tr class="bg-wzureish-white">
                                 <td>13:00-13:15</td>
                                 <td>15 mins</td>
                                 <td rowspan="2" style="vertical-align: inherit;"><b>Mobility Insights:</b> The Role of Telecom Data in Digital Twin Dynamics</td>
                                 <td>Airtel</td>
                                 <td>Sh. Abhishek Singh, Head of Customer Intelligence</td>
                              </tr>
                              <tr class="bg-wzureish-white">
                                 <td>13:15-13:30 </td>
                                 <td>15 mins</td>
                                 <td>Reliance Jio</td>
                                 <td>Sh. Rahul Joshi, AVP & Lead Analytics & Automation</td>
                              </tr>
                              <tr class="bg-misty-gray">
                                 <td>13:30-13:40</td>
                                 <td>10 mins</td>
                        ...
                        <table class="table table-bordered">
                           ...
                           <tbody class="text-center">
                              <tr class="bg-wzureish-white">
                                 <td>14:35-14:50</td>
                                 <td>15 mins </td>
                                 <td><b>Overcoming the Traditional Barriers in Data Sharing:</b> The Revolution with Privacy Enhancing Technologies (PETs)</td>
                                 <td>Microsoft</td>
                                 <td> Sh. Rajesh Ranjan, Director, Government Relations</td>
                              </tr>
                              <tr class="bg-wzureish-white">
                                 <td>14:50-15:05</td>
                                 <td>15 mins</td>
                                 <td rowspan="2" style="vertical-align: inherit;"><b>Imagining the Boundless:</b> Experimental Iterations through VR, AR, and AI</td>
                                 <td>Microsoft</td>
                                 <td>Sh. Keshri Asthana, CTO - Govt Business</td>
                              </tr>
                              <tr class="bg-wzureish-white">
                                 <td>15:05-15:20</td>
                                 <td>15 mins</td>
                                 <td>Meta + Parallax</td>
                                 <td>Sh. Ojasvi Bhatia</td>
                              </tr>
                              <tr class="bg-wzureish-white">
                                 <td>15:20-15:35</td>
                                 <td>15 mins</td>
                              ...
                              <tr class="bg-wzureish-white">
                                 ...
                                 <td>15 mins</td>
                                 <td>WhatsApp</td>
                                 <td>Sh. Animesh Baidya Biswas</td>
                              </tr>
                              <tr class="bg-fresh-mint">
                                 <td>15:50-16:15</td>
                                 <td>25 mins</td>
                        ...
                        <table class="table table-bordered">
                           ...
                           <tbody class="text-center">
                              <tr class="bg-wzureish-white">
                                 <td>16:15-16:35</td>
                                 <td>20 mins</td>
                                 <td><b>Global Synergy:</b> Unveiling Interconnected Digital Twins and International Best Practices </td>
                                 <td>Digital Twin Consortium</td>
                                 <td>Dr. Javier</td>
                              </tr>
                              <tr class="bg-wzureish-white">
                                 <td>16:35-17:30</td>
         ...
         <div class="custom-tab-content" id="tab2" style="display: none;">
            <h5 class="mt-10 blink-text text-center mb-4" style="color: #ff0000b8;">9th March 2024 (09:30 to 17:00)</h5>
            <div class="event_accordion">
               <div class="event_accordion-item">
                  <button id="event_accordion-button-1" aria-expanded="false">
   ...
   <div class="features-wrapper-two main-bg wow fadeInDown" style="visibility: visible; animation-name: fadeInDown;">
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
               <div class="single-counter-item-two wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                  <div class="inner-counter">
                     <div class="icon">
                     </div>
...
<section class="faq-section pt-50 pb-50" id="speakersDes">
   <div class="container">
      <div class="event_accordion" id="event_accordionOne">
         <div class="row justify-content-center">
            <div class="col-lg-10">
               <div class="section-title text-center mb-30 wow fadeInDown">
                  <!-- <span class="sub-title"><img src="<?php echo base_url(''); ?>include/web/custom/technology.png" alt="" /> Weaving the Fabric of Events</span> -->
                  <h2>Outreach Program Dignitaries & Speakers</h2>
               </div>
            </div>
         </div>
         <div class="custom-tabs">
            <button class="custom-tab-btn" data-tab="tab4">Sangam Delhi</button>
            <button class="custom-tab-btn " data-tab="tab5">Sangam Bangalore</button>
            <button class="custom-tab-btn active" data-tab="tab6">Sangam Hyderabad</button>
         </div>
      </div>
      <div class="custom-tab-content" id="tab4" style="display: none;">
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-12">
      ...
      <div class="custom-tab-content" id="tab5" style="display: none;">
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-12">
      ...
      <div class="custom-tab-content text-center" id="tab6">
         ...
         <div class="row speakerSection wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
            <div class="single-project-item-four col-md-3">
               ...
               <div class="text_for_outreach height_150">
                  <p class="title" style="margin-bottom: 5px; font-weight: bold;"><a href="javascript:void(0)">Aditya khaitan</a></p>
                  <h5 style="color: #2f2f2f;font-size: 17px;font-family: 'Montserrat', sans-serif;font-weight: bold;">Partner, Telco-Technology and 5G Leader</h5>
                  <h4 style="color: #2f2f2f;font-size: 16px;font-family: 'Montserrat', sans-serif;font-weight: 500;">Deloitte India</h4>
               </div>
            </div>
            <div class="single-project-item-four col-md-3">
               <div class="project-img">
               ...
               <div class="project-img">
                  ...
                  <div class="hover-content">
                     <div class="text text-white">
                        ...
                        <p style="font-size:13px">Dr. Adithya Balasubramanyam is an Augmented and Virtual Reality expert and faculty member at PES University, Bangalore. Leading the CAVE labs, he focuses on Digital Twins, Metaverse, and AR/VR applications for Medical Training. With a PhD in Computer Graphics and Virtual Reality from South Korea, he brings rich experience from roles at Schneider Electric and Jyothy Institute of Technology. Dr. Adithya has filed 4 patents, published extensively in top venues, and mentors both PhD and undergraduate students.</p>
                     </div>
                  </div>
                  <div class="project-content">
                     <div class="text text-white">
