   ...
   <div class="container">
      <div class="event_accordion" id="event_accordionOne">
         ...
         <div class="custom-tabs">
            ...
            <button class="custom-tab-btn active" data-tab="tab2">Sangam Bangalore</button>
            <button class="custom-tab-btn" data-tab="tab3">Sangam Hyderabad</button>
         </div>
         ...
         <div class="custom-tab-content text-center" id="tab3" style="display: none;">
            <h4>Coming Soon!</h4>
         </div>
      </div>
   </div>
   ...
   <div class="container">
      <div class="event_accordion" id="event_accordionOne">
         ...
         <div class="custom-tabs">
            ...
            <button class="custom-tab-btn active" data-tab="tab5">Sangam Bangalore</button>
            <button class="custom-tab-btn" data-tab="tab6">Sangam Hyderabad</button>
         </div>
      </div>
