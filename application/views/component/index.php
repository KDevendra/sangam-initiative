                     ...
                     <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarDashboards">
                           <ul class="nav nav-sm flex-column">
                              ...
                              <li class="nav-item">
                                 <a href="<?php echo base_url('admin-dashboard')?>" class="nav-link" data-key="t-ecommerce"> Ecommerce </a>
                              </li>
                              <li class="nav-item">
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                       ...
                                       <?php
                                          ...
                                          if ($user_level === '0') {
                                              ?>
                                       <li class="nav-item">
                                          <a href="<?php echo base_url('project-settings')?>" class="nav-link" data-key="t-settings"> Settings </a>
                                       </li>
                                       <?php
                                          }
                                          ?>
