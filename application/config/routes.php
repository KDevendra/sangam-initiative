...
$route['media-content'] = 'BaseController/mediaContent';
...
$route['eoi-registration/(:any)/(:any)'] = 'AdminController/eoiRegistration/$1/$2';
...
$route['submit-media'] = 'AdminController/submiMedia';
...
$route['media'] = 'AdminController/media';
$route['media/(:any)'] = 'AdminController/media/$1';
$route['media/(:any)/(:any)'] = 'AdminController/media/$1/$2';
...
$route['user-media-ation/(:any)/(:any)'] = 'AdminController/userMediaAction/$1/$2';
